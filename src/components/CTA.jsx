  ...
  return (
    <section id="cta" ref={containerRef} className="py-32 px-6 bg-obsidian text-center rounded-t-[3rem] border-t border-ivory/10 relative z-20 shadow-[0_-20px_50px_rgba(0,0,0,0.5)] flex flex-col items-center">
      <div className="relative z-10 flex flex-col items-center">
        <div className="flex items-center gap-3 bg-slate/50 backdrop-blur-md border border-ivory/10 px-5 py-2.5 rounded-full">
      ...
      <div ref={btnRef} className="magnetic-btn">
        <a 
          ...
          className="group relative inline-flex items-center justify-center bg-champagne text-obsidian px-10 py-5 rounded-full font-sans uppercase tracking-[0.2em] font-medium text-sm overflow-hidden transition-all duration-300 shadow-[0_0_40px_rgba(201,168,76,0.3)] hover:shadow-[0_0_60px_rgba(201,168,76,0.5)]"
        >
